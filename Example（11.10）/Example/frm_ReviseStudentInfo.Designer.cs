namespace Example
{
    partial class frm_ReviseStudentInfo
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Controls.Add(this.lbl_PasswordProtectProblem2);
            this.Controls.Add(this.lbl_Answer1);
            this.Controls.Add(this.lbl_PasswordProtectProblem1);
            this.Controls.Add(this.lbl_Name);
            this.Controls.Add(this.lbl_StudentNumber);
            this.Controls.Add(this.txt_Name);
            this.Controls.Add(this.txt_PasswordProtectProblem1);
            this.Controls.Add(this.txt_Answer2);
            this.Controls.Add(this.txt_PasswordProtectProblem2);
