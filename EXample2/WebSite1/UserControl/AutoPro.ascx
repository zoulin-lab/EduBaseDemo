...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" >
  <ContentTemplate>
    ...
    <asp:GridView ID="gvProduct" BackColor="#f0f0f0" runat="server" AllowPaging="True" AutoGenerateColumns="false" OnPageIndexChanging="gvProduct_PageIndexChanging" PagerSettings-Mode="NextPrevious" PageSize="1" Width="592px" Height="16px">
          ...
          <ItemTemplate >
            <table style="border: 0.5px solid #808080; width: 100%;" >
              <tr>
                ...
                <td style="border: 0.5px solid #808080; " class="auto-style11">商品编号： </td>
                <td style="border: 0.5px solid #808080; " class="auto-style6">
                  <asp:Label ID="lblProductId" runat="server" Text='<%# Bind("ProductId") %>'></asp:Label>
                </td>
              </tr>
              <tr>
                <td style="border: 0.5px solid #808080;" class="auto-style11">商品名称： </td>
                <td style="border: 0.5px solid #808080;" class="auto-style6">
                  <asp:Label ID="lblName" runat="server" Text='<%# Bind("ProductName") %>'></asp:Label>
                </td>
              </tr>
                <tr>
                <td style="border: 0.5px solid #808080;" class="auto-style11">商品描述： </td>
                <td style="border: 0.5px solid #808080;" class="auto-style6">
                  <asp:Label ID="Label1" runat="server" Text='<%# Bind("Descn") %>'></asp:Label>
                </td>
              </tr>
                <tr>
                <td style="border: 0.5px solid #808080;" class="auto-style11">配送时间：</td>
                <td style="border: 0.5px solid #808080;" class="auto-style6">
                  <asp:Label ID="Label2" runat="server" Text='<%# Bind("DeliveryTime") %>'></asp:Label>
                </td>
              </tr>
              <tr>
                <td style="border: 0.5px solid #808080;" class="auto-style11">商品价格</td>
                <td style="border: 0.5px solid #808080;" class="auto-style6">
                  <asp:Label ID="lblListPrice" runat="server" Text='<%# Bind("ListPrice") %>'></asp:Label>
                </td>
              </tr>
              <tr>
                <td style="border: 0.5px solid #808080;" class="auto-style11">月销： </td>
                <td style="border: 0.5px solid #808080;" class="auto-style6">
