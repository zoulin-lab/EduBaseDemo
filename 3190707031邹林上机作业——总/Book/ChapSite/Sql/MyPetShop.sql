...
ON 
( NAME = MyPetShop,
    FILENAME = 'D:\杂物\网站建设相关\3190707031邹林上机作业（10.12）\Book\ChapSite\App_Data\MyPetShop.mdf',
    SIZE = 5MB,
    MAXSIZE = 50MB,
    FILEGROWTH = 1MB )
LOG ON
( NAME = MyPetShop_log,
    FILENAME = 'D:\杂物\网站建设相关\3190707031邹林上机作业（10.12）\Book\ChapSite\App_Data\MyPetShop_log.ldf',
    SIZE = 3MB,
    MAXSIZE = 25MB,
    FILEGROWTH = 1MB )
